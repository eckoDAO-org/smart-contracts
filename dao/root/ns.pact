...
(write-registry "util" GUARD_FAILURE true)
(write-registry "kaddex" GUARD_FAILURE true)
...
(define-namespace "util" GUARD_SUCCESS GUARD_FAILURE)
(define-namespace "kaddex" GUARD_SUCCESS GUARD_FAILURE)
