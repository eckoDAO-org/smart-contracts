;; This module manages the liquidity tokens used by `exchange`.
;;
;; The module functions are pretty much the same as a regular
;; fungible-v2 token, but with an extra string parameter that
